...
# Monitoreo Inteligente de Signos Vitales 
...
## Informe
[Informe final del proyecto](./Anexos/Informe%20final%20de%20Proyecto_%20Monitoreo%20Inteligente%20de%20Signos%20Vitales.pdf)

<!-- Link que permita acceder al Informe, el cual debe estar subido a este repositorio -->

## Implementación

Se incluyen dos videos de la implementación: uno correspondiente al funcionamiento normal del sistema y otro en el que se observa la activación de la alerta ante valores fuera de rango.
<!-- Video explicativo del funcionamiento del proytecto -->

**Implementación básica**

[![Video del funcionamiento del proyecto](https://img.youtube.com/vi/F6kXOJYDGYw/0.jpg)](https://youtube.com/shorts/F6kXOJYDGYw) 




**Implementación con alerta**

[![Video del funcionamiento del proyecto](https://img.youtube.com/vi/h2yztBm5WiM/0.jpg)](https://www.youtube.com/shorts/h2yztBm5WiM)


## Lista de anexos

En la carpeta [`src`](./src) se encuentran los anexos adicionales del proyecto, incluyendo el código fuente utilizado y el diseño de bloques.
